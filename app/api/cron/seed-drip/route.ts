...
//
// 2026-08-02: 디자인 시안 통일 직후 기획이 유동적인 동안 기존 시드 계정 30개 + 콘텐츠 24개를
// 전량 삭제하고 이 크론도 잠시 비활성화했었음. 같은 날 룸(6)×플레어(24) 체계 확정을 확인하고
// 새 시드 페르소나 30명 + 신규 콘텐츠 24개(룸/플레어 조합당 1개)를 다시 채운 뒤 vercel.json에
// 크론을 재등록해 다시 활성화함.
//
